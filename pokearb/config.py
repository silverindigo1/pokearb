...
SHOPS: tuple[Shop, ...] = (
    ...
    # --- Danish sweep, 2026-09-23 (SOURCES.md section G) -------------------
    Shop(
        key="halmeshule",
        name="Halmeshule",
        country="DK",
        currency="DKK",
        adapter="shopify",
        base_url="https://halmeshule.dk",
        ships_to_dk=True,
        collections=("pokemon-produkter", "preorder",),
        shipping=Shipping(
            amount=49.0,
            free_over=699.0,
            source_url="https://halmeshule.dk/pages/terms-and-conditions",
            checked="2026-09-23",
            verified=True,
            note="Fra 49 kr., gratis fra 699 kr.",
        ),
    ),
    Shop(
        key="cappai",
        ...
        currency="DKK",
        adapter="shopify",
        base_url="https://cappai.dk",
        ships_to_dk=True,
        shipping=Shipping(
            amount=55.0,
            source_url="https://cappai.dk/products/levering",
            checked="2026-09-23",
            verified=True,
            note="GLS 55 kr., saelges som en vare i shoppen.",
        ),
        notes="Live-stream butik med ca. 35 varer, derfor hele feedet.",
    ),
    Shop(
        key="spilforsyningen",
        ...
        currency="DKK",
        adapter="shopify",
        base_url="https://spilforsyningen.dk",
        ships_to_dk=True,
        collections=("pokemon",),
        shipping=Shipping(
            amount=42.0,
            free_over=599.0,
            source_url="https://spilforsyningen.dk/pages/handelsbetingelser",
            checked="2026-09-23",
            verified=True,
            note="Pakkeshop 42 kr., gratis over 599 kr.",
        ),
    ),
    Shop(
        key="pokecards",
        ...
        currency="DKK",
        adapter="woocommerce",
        base_url="https://pokecards.dk",
        ships_to_dk=True,
        collections=("16",),
        shipping=Shipping(
            amount=40.0,
            free_over=599.0,
            source_url="https://pokecards.dk/Handelsbetingelser/",
            checked="2026-09-23",
            verified=True,
            note="Pakkeshop 40 kr., gratis over 599 kr.",
        ),
    ),
    Shop(
        key="ergames",
        ...
        shipping=Shipping(
            amount=45.0,
            free_over=1000.0,
            source_url="https://er-games.dk/handelsbetingelser/",
            checked="2026-09-23",
            verified=True,
            note="PostNord pakkeshop 45 kr., gratis over 1.000 kr.",
        ),
        notes="robots.txt: Crawl-delay 10.",
    ),
    Shop(
        key="snydepels",
        name="Snydepels",
        ...
        currency="DKK",
        adapter="shopify",
        base_url="https://snydepels.dk",
        ships_to_dk=True,
        collections=("tcg-ccg-pokemon",),
        shipping=Shipping(
            amount=39.0,
            free_over=1000.0,
            source_url="https://snydepels.dk/pages/fragt",
            checked="2026-09-23",
            verified=True,
            note="GLS pakkeshop 49 kr. under 250 kr., 39 kr. fra 250 kr., gratis fra 1.000 kr. PokeArb bruger 39.",
        ),
    ),
    Shop(
        key="funshop",
        ...
        currency="DKK",
        adapter="shopify",
        base_url="https://www.fun-shop.dk",
        ships_to_dk=True,
        collections=("pokemon-bokse-og-tins", "bundles-og-saet",),
        shipping=Shipping(
            amount=44.0,
            free_over=799.0,
            source_url="https://www.fun-shop.dk/pages/fragt-levering",
            checked="2026-09-23",
            verified=True,
            note="37 til 44 kr., gratis fra 799 kr. PokeArb bruger 44.",
        ),
    ),
    Shop(
        key="papand",
        ...
        currency="DKK",
        adapter="shopify",
        base_url="https://papand.dk",
        ships_to_dk=True,
        collections=("pokemon-elite-trainer-box", "alt-pokemon",),
        shipping=Shipping(
            amount=39.0,
            source_url="https://papand.dk/policies/terms-of-service",
            checked="2026-09-23",
            verified=True,
            note="Fra 39 kr.",
        ),
    ...
    Shop(
        ...
        currency="DKK",
        adapter="shopify",
        base_url="https://www.tcgshoppen.dk",
        ships_to_dk=True,
        collections=("hele-vores-udvalg-af-pokemon",),
        shipping=Shipping(
            amount=39.0,
            source_url="https://www.tcgshoppen.dk/pages/handelsbetingelser",
            checked="2026-09-23",
            verified=True,
            note="Fra 39 kr.",
        ),
    ...
    Shop(
        ...
        currency="DKK",
        adapter="shopify",
        base_url="https://www.poke-shop.dk",
        ships_to_dk=True,
        collections=("booster-box", "etb", "pakker-og-bokse",),
        shipping=Shipping(
            amount=49.0,
            source_url="https://www.poke-shop.dk/policies/terms-of-service",
            checked="2026-09-23",
            verified=True,
            note="Fra 49 kr. med GLS.",
        ),
    ),
    Shop(
        key="cardsdirect",
        ...
        currency="DKK",
        adapter="shopify",
        base_url="https://cardsdirect.dk",
        ships_to_dk=True,
        shipping=Shipping(note="Oplyser ingen fragtpris."),
        notes="Ca. 55 varer, derfor hele feedet.",
    ),
    Shop(
        key="airsoftgeek",
        name="Airsoftgeek",
        ...
        currency="DKK",
        adapter="shopify",
        base_url="https://www.airsoftgeek.dk",
        ships_to_dk=True,
        collections=("pokemon",),
        shipping=Shipping(
            amount=29.95,
            source_url="https://www.airsoftgeek.dk/policies/terms-of-service",
            checked="2026-09-23",
            verified=True,
            note="Fra 29,95 kr.",
        ),
    ...
    Shop(
        ...
        currency="DKK",
        adapter="woocommerce",
        base_url="https://toysnloot.dk",
        ships_to_dk=True,
        collections=("646",),
        shipping=Shipping(
            amount=49.0,
            source_url="https://toysnloot.dk/handelsbetingelser/",
            checked="2026-09-23",
            verified=True,
            note="49 til 95 kr. efter fragtfirma. PokeArb bruger 49.",
        ),
    ),
    Shop(
        key="blazes",
        ...
        currency="DKK",
        adapter="woocommerce",
        base_url="https://blazes.dk",
        ships_to_dk=True,
        collections=("1740", "1741",),
        shipping=Shipping(note="GLS 1-2 dage, pris oplyses ikke."),
    ),
